...
<div class={cn("flex flex-col gap-6", className)} {...restProps}>
				...
				<div class="grid gap-6">
					...
					<div class="grid gap-6">
						<div class="grid gap-3">
							...
							<Input id="username-{id}" name="username" type="text" placeholder="johndoe" required />
						</div>
						<div class="grid gap-3">
							<Label for="display_name-{id}">Display Name</Label>
							<Input id="display_name-{id}" name="display_name" type="text" placeholder="John Doe" required />
						</div>
						<div class="grid gap-3">
	...
	<div class="text-muted-foreground text-balance text-center text-xs">
		By clicking continue, you agree to our <a href="##" class="underline underline-offset-4 hover:text-primary">Terms of Service</a> and <a href="##" class="underline underline-offset-4 hover:text-primary">Privacy Policy</a>.
	</div>
</div>
