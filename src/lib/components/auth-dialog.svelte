	...
	<Card class="overflow-hidden p-0 w-full max-w-sm md:max-w-3xl">
		<CardContent class="grid p-0 md:grid-cols-2">
			...
			<div class="bg-muted relative hidden md:block">
				<img src={'https://picsum.photos/600/800?random=' + Math.floor(Math.random() * 1000)} alt="placeholder" class="absolute inset-0 h-full w-full object-cover dark:brightness-[0.2] dark:grayscale" />
			</div>
		</CardContent>
	</Card>
</div>
