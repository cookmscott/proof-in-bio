...
<section
	class="overflow-hidden py-24 font-sans text-foreground selection:bg-primary selection:text-primary-foreground"
>
	<div class="container mx-auto px-4 md:px-6">
		<div class="flex flex-col items-center text-center mb-20 space-y-8">
			<h2
				class="max-w-6xl text-balance font-serif text-4xl font-semibold leading-[0.9] tracking-[-0.04em] text-foreground"
			>
				<span class="text-foreground">Your social post gets attention.</span>
				<span class="block text-primary">Your proof page gets trust.</span>
			</h2>

			<div class="flex flex-wrap items-center justify-center gap-2.5">
				<span
					class="inline-flex items-center rounded-full border border-zinc-300/80 px-4 py-1.5 text-[11px] font-semibold uppercase leading-none tracking-[0.22em] text-zinc-500 dark:border-zinc-700 dark:text-zinc-400"
				>
					Journalists
				</span>
				<span
		...
		>
			...
			<div class="relative group w-full max-w-[360px]">
				...
				<div class="absolute top-0 -left-8 z-30 animate-bounce-subtle pointer-events-none">
					...
					/>
					<div
						class="absolute right-0 -top-2 bg-accent text-foreground text-[10px] font-bold px-3 py-1.5 rounded-xl shadow-sm transform rotate-12"
					>
						Is this real? 🤔
					</div>
				</div>
				...
				<div
					class="relative phone-shell phone-shell-accent text-foreground rounded-[2.5rem] overflow-hidden h-[680px] flex flex-col shadow-2xl border-4 border-border"
				>
					<!-- App Header -->
					...
					<div class="px-6 pb-8 flex-1 flex flex-col">
						...
						>
							<Grid class="h-6 w-6 text-foreground" />
						</div>

						<!-- Grid -->
						<div class="grid grid-cols-3 gap-1 flex-1 content-start">
							{#each images as image, i (image.id)}
								<div class="aspect-square relative overflow-hidden bg-secondary rounded-md">
									<img src={image.url} alt="Post" class="w-full h-full object-cover" />
									{#if image.fake}
										<div class="absolute inset-0 bg-black/40 flex items-center justify-center">
											<div
												class="bg-primary text-primary-foreground px-3 py-1 rounded-full font-bold text-[10px] tracking-widest uppercase shadow-lg animate-slam-down"
					...
					<div class="p-6 flex justify-center">
						<div class="w-32 h-1.5 bg-border rounded-full"></div>
					</div>
				</div>
			</div>
			...
			<div class="relative group w-full max-w-[360px]">
				<div class="text-center mb-8">
					...
					<p class="text-sm text-muted-foreground">
						We check it’s real — not fake or AI-generated.
					</p>
				</div>
				...
				<div class="absolute top-0 -right-8 z-30 pointer-events-none w-28 h-28">
					...
					{:else}
						<div class="absolute inset-0 animate-bounce-subtle">
							...
							/>
							<div
								class="absolute left-0 -top-2 bg-accent text-foreground text-[10px] font-bold px-3 py-1.5 rounded-xl shadow-sm transform -rotate-12"
							>
								Real? 🤔
							</div>
						</div>
				...
				<div class="relative h-[680px] w-full">
					...
					<div
						class="swap-card phone-shell {showProof
							? 'top'
							: 'bottom'} phone-shell-accent absolute inset-0 text-foreground rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col border-4 border-border"
					>
						<!-- App Header -->
						<div class="flex justify-between items-center px-6 py-6">
					...
					<div
						class="swap-card phone-shell {showProof
							? 'bottom'
							: 'top'} phone-shell-card absolute inset-0 text-card-foreground rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col border-4 border-border"
					>
								...
								<div class="flex flex-row items-start gap-5">
									...
									<div class="flex flex-col pt-1 min-w-0">
										...
										<div class="mt-3 flex flex-wrap gap-1.5">
											{#each profileDennis.interests as interest (interest)}
												<Badge
													variant="secondary"
											...
											>
												...
												<div class="ml-3.5 flex-grow relative z-10">
													...
													>
														...
														<span class="opacity-90">Not fake or AI-generated</span>
													</div>
												</div>
											</div>
										{/if}
...
<style>
	...
	.phone-shell-card {
		background-color: color-mix(in srgb, var(--color-card) 60%, white);
	}
	.phone-shell::before {
		content: '';
		position: absolute;
	...
	:global(.dark) .phone-shell-accent {
		background-color: var(--color-accent);
	}
	:global(.dark) .phone-shell-card {
