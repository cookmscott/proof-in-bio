<script>
	...
	import { CheckCircle, Grid, Heart, MessageCircle, ShieldCheck } from 'lucide-svelte';
	...
	let profile = {
		...
		username: 'elena_ruiz_photo',
		bio: 'Documentary photographer | conflict, migration, and environmental stories',
		avatar_url: 'https://i.pravatar.cc/150?u=sarah',
		interests: ['Editorial', 'Documentary', 'Field Work']
	};

	let profileDennis = {
		display_name: 'Mara Levin',
		username: 'maralevinstudio',
		bio: 'Fine art photographer | archival pigment prints | represented works',
		link: 'proofin.bio/maralevin',
		avatar_url: 'https://i.pravatar.cc/150?u=dennis',
		interests: ['Fine Art', 'Edit History', 'Proof Link']
	};
...
<section
	class="py-24 dark:bg-[#0a0a0a] text-zinc-900 dark:text-zinc-100 overflow-hidden font-sans selection:bg-orange-500 selection:text-white"
>
	<div class="container mx-auto px-4 md:px-6">
		<div class="flex flex-col items-center text-center mb-20 space-y-6">
			<span class="text-xs font-bold tracking-widest text-zinc-500 uppercase">
				Platform Attention vs. Provenance Trust
			</span>
			<h2 class="text-4xl md:text-6xl font-bold leading-[0.95] tracking-tight">
				Your social post gets attention.
				<span class="text-red-500">Your proof page gets trust.</span>
			</h2>
			<p class="mx-auto max-w-[600px] text-zinc-500 dark:text-zinc-400 text-lg leading-relaxed">
				Social platforms help your work circulate. Proof pages help people verify what they are
				looking at.
			</p>
			<div
				class="flex flex-wrap justify-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-zinc-500"
			>
				<span class="rounded-full border border-border bg-background px-3 py-1.5">Journalists</span>
				<span class="rounded-full border border-border bg-background px-3 py-1.5">Creators</span>
				<span class="rounded-full border border-border bg-background px-3 py-1.5">Fine Art</span>
			</div>
		</div>

		<div
			class="grid lg:grid-cols-2 gap-20 lg:gap-24 items-start max-w-5xl mx-auto justify-items-center"
		>
			<!-- The "Other" App (Instagram Style) -->
			<div class="relative group w-full max-w-[360px]">
				<div class="text-center mb-8">
					<h2 class="text-xl font-bold mb-2 text-red-500">Unverified portfolio</h2>
					<p class="text-sm text-zinc-500 dark:text-zinc-400">
						The work is visible, but the provenance record is nowhere people can inspect it.
					</p>
				</div>
				<!-- Thinking Cat (Always suspicious) -->
				<div class="absolute top-0 -left-8 z-30 animate-bounce-subtle pointer-events-none">
					<img
						src="/landing/cat_think.gif"
						alt="Thinking Cat"
						class="w-28 h-28 object-contain drop-shadow-xl"
					/>
					<div
						class="absolute right-0 -top-2 bg-[#FFF9EE] dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 text-[10px] font-bold px-3 py-1.5 rounded-xl shadow-sm transform rotate-12"
					>
						Can I trust this? 🤔
					</div>
				</div>
				...
				<div
					class="relative phone-shell bg-[#FFF9EE] dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 rounded-[2.5rem] overflow-hidden h-[680px] flex flex-col shadow-2xl border-4 border-zinc-200 dark:border-zinc-800"
				>
					<!-- App Header -->
					...
					<div class="px-6 pb-8 flex-1 flex flex-col">
						...
						<div class="flex items-center gap-6 mb-6">
							<div
								class="w-20 h-20 rounded-full p-1 bg-gradient-to-tr from-amber-300 via-primary to-zinc-800"
							>
								<img
							...
							<div class="flex-1 flex justify-around text-center">
								<div>
									...
									<div class="text-[10px] uppercase tracking-wider opacity-60">Stories</div>
								</div>
								<div>
									<div class="font-bold text-lg">6</div>
									<div class="text-[10px] uppercase tracking-wider opacity-60">Clients</div>
								</div>
								<div>
									<div class="font-bold text-lg">2</div>
									<div class="text-[10px] uppercase tracking-wider opacity-60">Awards</div>
								</div>
							</div>
						</div>
						...
						<!-- Tabs -->
						<div
							class="flex justify-around border-t border-zinc-200 dark:border-zinc-800 py-3 mb-1"
						>
						...
						<div class="grid grid-cols-3 gap-1 flex-1 content-start">
							{#each images as image, i}
								<div
									class="aspect-square relative overflow-hidden bg-zinc-100 dark:bg-zinc-800 rounded-md"
								>
									<img src={image.url} alt="Post" class="w-full h-full object-cover" />
									{#if image.fake}
										<div class="absolute inset-0 bg-black/40 flex items-center justify-center">
											<div
												class="bg-red-500 text-white px-3 py-1 rounded-full font-bold text-[10px] tracking-widest uppercase shadow-lg animate-slam-down"
			...
			<!-- Right Side: Proof-backed portfolio -->
			<div class="relative group w-full max-w-[360px]">
				<div class="text-center mb-8">
					<h3 class="text-xl font-bold mb-2 text-verified">Proof-backed portfolio</h3>
					<p class="text-sm text-zinc-500 dark:text-zinc-400">
						Social platforms are not built for provenance. Proof in Bio is.
					</p>
				</div>
				...
				<div class="absolute top-0 -right-8 z-30 pointer-events-none w-28 h-28">
					{#if showProof}
						<div class="absolute inset-0 animate-bounce-subtle">
							<img
								src="/landing/cat_happy.gif"
								alt="Happy Cat"
								class="w-full h-full object-contain drop-shadow-xl"
							/>
							<div
								class="absolute left-0 -top-2 bg-verified text-verified-foreground text-[10px] font-bold px-3 py-1.5 rounded-xl shadow-sm transform -rotate-12"
							>
								Proven! ✅
							</div>
						</div>
					{:else}
						<div class="absolute inset-0 animate-bounce-subtle">
							...
							/>
							<div
								class="absolute left-0 -top-2 bg-[#FFF9EE] dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100 text-[10px] font-bold px-3 py-1.5 rounded-xl shadow-sm transform -rotate-12"
							>
								Checking proof...
							</div>
						</div>
				...
				<div class="relative h-[680px] w-full">
					...
					<div
						class="swap-card phone-shell {showProof
							? 'top'
							: 'bottom'} absolute inset-0 bg-[#FFF9EE] dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col border-4 border-zinc-200 dark:border-zinc-800"
					>
						<!-- App Header -->
						<div class="flex justify-between items-center px-6 py-6">
							...
							<div class="flex items-center gap-6 mb-6">
								...
								<div class="flex-1 flex justify-around text-center">
									<div>
										...
										<div class="text-[10px] uppercase tracking-wider opacity-60">Works</div>
									</div>
									<div>
										<div class="font-bold text-lg">11</div>
										<div class="text-[10px] uppercase tracking-wider opacity-60">Collectors</div>
									</div>
									<div>
										<div class="font-bold text-lg">4</div>
										<div class="text-[10px] uppercase tracking-wider opacity-60">Shows</div>
									</div>
								</div>
							</div>
					...
					<div
						class="swap-card phone-shell {showProof
							? 'bottom'
							: 'top'} absolute inset-0 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col border-4 border-zinc-200 dark:border-zinc-800"
					>
						...
						<div class="flex-1 overflow-hidden">
							...
							<div class="flex justify-between items-center px-6 pt-8 pb-4">
								<div class="flex items-center gap-2">
									<div
										class="w-6 h-6 rounded-full bg-gradient-to-tr from-orange-400 to-red-500"
									></div>
									<a href="/"><span class="font-bold text-lg tracking-tight">ProofInBio</span></a>
								</div>
								<div
									class="w-8 h-8 rounded-full bg-zinc-100 dark:bg-zinc-800 overflow-hidden border border-zinc-200 dark:border-zinc-700"
								>
									<img
							...
							<div class="px-6 pb-6">
								<div class="flex flex-row items-start gap-5">
									...
									<div class="flex-shrink-0">
										<Avatar
											class="h-20 w-20 border-4 border-zinc-50 dark:border-zinc-900 shadow-sm"
										>
											<AvatarImage
												src={profileDennis.avatar_url}
												alt={profileDennis.display_name}
											/>
									...
									<div class="flex flex-col pt-1 min-w-0">
										<h1
											class="text-xl font-bold tracking-tight leading-none text-zinc-900 dark:text-zinc-100"
										>
											{profileDennis.display_name}
										</h1>
										<p class="text-xs text-zinc-400 dark:text-zinc-500 font-medium mt-1">
											@{profileDennis.username}
										</p>
										<p
											class="mt-2 text-xs text-zinc-600 dark:text-zinc-400 leading-relaxed line-clamp-3"
										>
											{profileDennis.bio}
										</p>
										<div class="mt-3 flex flex-wrap gap-1.5">
											{#each profileDennis.interests as interest}
												<Badge
													variant="secondary"
													class="bg-zinc-100 dark:bg-zinc-800 text-zinc-500 dark:text-zinc-400 hover:bg-zinc-200 dark:hover:bg-zinc-700 border-0 text-[9px] px-2 py-0.5 rounded-full font-medium"
													>{interest}</Badge
												>
											{/each}
										</div>
								...
								<div class="mt-6 min-h-[64px]">
									{#key showProof}
										{#if showProof}
											<div
												class="relative overflow-hidden bg-gradient-to-br from-verified to-verified/80 shadow-lg shadow-verified/20 flex w-full items-center rounded-2xl p-3 text-verified-foreground animate-bam border border-verified/30"
											>
												<!-- Subtle background glows -->
												<div
													class="absolute -left-8 -top-8 w-24 h-24 bg-white/20 rounded-full blur-2xl pointer-events-none"
												></div>
												<div
													class="absolute -right-4 -bottom-4 w-16 h-16 bg-verified/40 rounded-full blur-xl pointer-events-none"
												></div>

												<!-- Icon -->
												<div
													class="bg-white/20 shadow-[inset_0_2px_4px_rgba(255,255,255,0.3)] w-10 h-10 rounded-full flex items-center justify-center shrink-0 relative z-10 backdrop-blur-sm border border-white/10"
												>
													<ShieldCheck
												...
												<!-- Text Content -->
												<div class="ml-3.5 flex-grow relative z-10">
													<h5
														class="font-extrabold text-[11px] uppercase tracking-[0.15em] text-white/90 leading-tight mb-0.5 drop-shadow-sm"
													>
														Verified proof record
													</h5>
													<div
														class="text-[12px] text-white font-medium leading-none flex items-center gap-2"
													>
														...
														<span class="opacity-90"
															>Ready for clients, collectors, and editors</span
														>
													</div>
												</div>
											</div>
							...
							<div class="px-6 pb-10">
								<div class="grid grid-cols-3 gap-1">
									{#each images as image, i}
										<div
											class="aspect-square relative overflow-hidden bg-zinc-100 dark:bg-zinc-800 rounded-lg"
										>
											<img
												src={image.url}
												alt="Portfolio piece"
											...
											<div
												class="absolute top-1 right-1 bg-verified text-verified-foreground rounded-full p-0.5 shadow-sm"
											>
					...
					<div
						...
						style="
                            top: 240px;
                            left: 30%;
                            transform: translate(-10%, -10%) translate({showHand
							? '0px, 0px'
							: '20px, 20px'}) scale({clickHand ? 0.9 : 1});
                            opacity: {showHand ? 1 : 0};
                        "
					>
						<img
							src="/landing/mini_pointer.png"
							alt="Hand cursor"
	...
	@keyframes toBottom {
		...
		10% {
			transform: translate3d(
					calc((var(--x-static) * 0.8) + (var(--x-offset) * 0.309)),
		...
		30% {
			transform: translate3d(
					calc((var(--x-static) * 0.4) + (var(--x-offset) * 0.809)),
