		...
		<div class="grid lg:grid-cols-2 gap-12 lg:gap-24 items-start max-w-5xl mx-auto justify-items-center">
			...
			<div class="relative group w-full max-w-[340px]">
				...
				<div class="relative bg-white dark:bg-black border-4 border-gray-200 dark:border-gray-800 rounded-[2.5rem] overflow-hidden shadow-2xl h-[650px] flex flex-col">
						...
						<div class="grid grid-cols-3 gap-0.5">
							{#each images as image, i}
								<div class="aspect-square relative overflow-hidden bg-gray-100">
									...
									{#if image.fake}
										<div class="absolute inset-0 bg-black/40 flex items-center justify-center animate-pulse-slow">
											<div class="bg-red-500 text-white px-2 py-0.5 rounded-full transform -rotate-12 font-bold text-[8px] border border-white shadow-lg animate-bounce-subtle">
												FAKE ✕
											</div>
										</div>
									{/if}
					...
					<div class="mt-auto border-t border-gray-100 dark:border-gray-800 p-3 flex justify-around items-center bg-white dark:bg-black relative z-10">
						<div class="w-5 h-5 bg-black dark:bg-white rounded-full"></div>
					</div>
				</div>
			...
			<div class="relative group w-full max-w-[340px]">
				...
				<div class="relative h-[650px] w-full">
					...
					<div class="swap-card {showProof ? 'bottom' : 'top'} absolute inset-0 bg-white dark:bg-black border-4 border-gray-200 dark:border-gray-800 rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col">
						<!-- Fake Phone Status Bar -->
						<div class="h-6 w-full flex justify-between items-center px-6 mt-2 text-[10px] font-medium opacity-50">
							<span>9:41</span>
							<div class="flex gap-1">
					...
					<div class="swap-card {showProof ? 'top' : 'bottom'} absolute inset-0 bg-background text-foreground border-4 border-gray-200 dark:border-gray-800 rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col">
						<!-- Fake Phone Status Bar -->
						<div class="h-6 w-full flex justify-between items-center px-6 mt-2 text-[10px] font-medium opacity-50">
							<span>9:41</span>
							<div class="flex gap-1">
						...
						<!-- Tab Bar -->
						<div class="mt-auto border-t border-gray-100 dark:border-gray-800 p-3 flex justify-around items-center bg-background relative z-10">
							<div class="w-5 h-5 bg-black dark:bg-white rounded-full"></div>
						</div>
					</div>
				</div>
				...
				<div class="text-center mt-6">
					<h3 class="text-xl font-bold mb-2 text-green-600">Link in Bio</h3>
