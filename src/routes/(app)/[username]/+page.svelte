<!--
  File: src/routes/(app)/[username]/+page.svelte
  Description: This component creates the main user profile page. It displays user
  information at the top, an alert about photo authentication, and a responsive
  grid of photos. A floating "Add Photos" button is fixed to the bottom-right corner.
-->
<script>
...
<div class="bg-background text-foreground min-h-screen">
    <main class="relative container mx-auto px-0 sm:px-4 py-8">
        <!-- Hero Background -->
        <div
        class="absolute -top-8 left-1/2 h-[400px] w-screen -translate-x-1/2 hidden dark:block"
    >
        <img
